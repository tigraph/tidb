...
var MySQLErrName = map[uint16]*mysql.ErrMessage{
	...
	ErrDuplicateVertexTable:                   mysql.Message("Duplicate vertex table '%-.192s'", nil),
	ErrDuplicateEdgeTable:                     mysql.Message("Duplicate vertex table '%-.192s'", nil),
	ErrDuplicateProperty:                      mysql.Message("Duplicate property '%-.192s'", nil),
	ErrLabelContainsDifferentProperties:       mysql.Message("Tables have the same label '%-.192s' but contain different properties", nil),
